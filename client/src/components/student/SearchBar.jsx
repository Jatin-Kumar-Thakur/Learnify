...
const SearchBar = ({ data }) => {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className='flex items-center border border-gray-300 rounded h-12 md:h-12 w-full max-w-xl justify-between'>
        ...
        <button type='submit' className='border rounded bg-blue-600 md:py-2 py-2 mx-1 md:px-10 px-7'>Search</button>
      </form>
    </div>
  )
}
